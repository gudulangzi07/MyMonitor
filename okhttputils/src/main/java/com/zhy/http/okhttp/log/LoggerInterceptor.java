                ...
                if (body != null) {
                    ...
                    if (mediaType != null) {
                        ...
                        if (isText(mediaType)) {
                            ...
                            /*********************本地log文件*****************************/
                            File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/MMMerchant/log");
                            if (!file.exists()) {
                                file.mkdirs();
                            }
                            File file2 = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/MMMerchant/log", "mmshop.txt");
